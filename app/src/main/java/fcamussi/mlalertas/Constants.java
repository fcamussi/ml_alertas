...
class Constants {
    ...
    public final static int SEARCH_MAX_RESULT_COUNT = 1000;
    ...
    public final static String ADD_SEARCH_MAX_RESULT_COUNT = "fcamussi.mlalertas.ADD_SEARCH_MAX_RESULT_COUNT";
